...
//  Utility function designed to handle CSS class names efficiently
export function cn(...inputs: ClassValue[]) {  //  can accept any number of arguments.
  return twMerge(clsx(inputs)); //  merges Tailwind CSS classes
}
